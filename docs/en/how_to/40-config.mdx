...
| ---------------------- | ---------------------------- | --------------------------------------------------------------------------- |
| Intra-cluster: TLS<br />External: TLS | SCRAM-SHA-512 or none               | CA certificate: `ca.p12`<br />Client configuration file: `client-ssl.properties`                      |
| Intra-cluster: TLS<br />External: TLS | TLS                           | CA certificate: `ca.p12`<br />User certificate: `user.p12`<br />Client configuration file: `client-ssl.properties` |
