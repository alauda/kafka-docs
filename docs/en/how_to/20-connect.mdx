...
| --------------| --------------------------------------- | --------------------- | --------------------------------------------- |
| Internal | Disabled                               | Disabled              | Testing scenario                               |
| Internal | Disabled                               | Enabled               | Testing scenario                               |
| Internal | Enabled SCRAM-SHA-512 (recommended)   | Disabled              | Access through the internal network, messages are transmitted without encryption, but authentication is required for sending and receiving messages.  |
| Internal | Enabled SCRAM-SHA-512 or TLS (more secure) | Enabled          | Access through the internal network, messages are transmitted with encryption, and authentication is required for sending and receiving messages. (Higher security, performance may be affected) |
...
| Internal/External Connection | The application selects the required connection address based on its location. |
