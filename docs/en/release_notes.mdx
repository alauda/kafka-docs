...
Alauda Streaming Services for Kafka's lifecycle havs been decoupled from platform's, which means when customer needs a certain feature or a bug fix, Kafka team can release immediately instead of waiting for the platform release together.
