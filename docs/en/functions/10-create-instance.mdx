...
my-cluster   4.2       Active   <none>                                    2025-03-06T08:46:57Z
test42       4.2       Failed   Pod is unschedulable or is not starting   2025-03-06T08:46:36Z
```
...
| :---------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| NAME              | Instance Name                                                                                                                                                                                                 |
| VERSION           | Currently only supports version: `4.2`                                                                                                                                                         |
...
## Create Single-Node Kafka Instance \{#create-single-node-kafka-instance}
