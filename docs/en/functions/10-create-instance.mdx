...
You can create a Kafka instance to achieve faster read and write speeds, along with scalable services that meet diverse and high availability requirements for your business.
  ...
  <Tab label="Web Console">
    ...
    4. Complete the relevant configurations with the following instructions.
           ...
           <table border="">
             ...
             <tr>
               <td rowspan="2"><b>Cluster Access Method</b></td>
             ...
             <tr>
               ...
               <td>After enabling the specified host port, you can specify the service port number. <br /><b>Note</b>: When updating the instance, the ports are not interchangeable. If you need to swap ports, you can first update to another unoccupied port and then re-specify.</td>
             </tr>
